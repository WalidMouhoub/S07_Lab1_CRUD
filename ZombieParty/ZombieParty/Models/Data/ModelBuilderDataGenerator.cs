    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId = 3, Name = "Primoridum Vandal", Description = "The best gun in the game", Force = 160, Image = "https://valorantstrike.com/valorant-primordium-skins/", Price = 2175, Qty = 20, QtyBought = 10, CreatedDate = new DateTime(2024, 08, 1) }
            );
            #endregion
        }
    }
